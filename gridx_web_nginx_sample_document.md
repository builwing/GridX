...
server {
    ...
    # SSL証明書の設定（Let's Encryptで自動生成される）
    ssl_certificate /etc/letsencrypt/live/gridx.winroad.biz/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/gridx.winroad.biz/privkey.pem;
